...
templates['teaching/tests/main.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"row\">\n    <div id=\"left-column\" class=\"col-xs-offset-2 col-xs-8 lesson-step\">\n        <nav class=\"row\">\n            <button id=\"btn-prev\" class=\"btn btn-primary\">Prev</button>\n            <button id=\"btn-submit\" class=\"pull-right btn btn-success\">Submit Test</button>\n            <button id=\"btn-next\" class=\"pull-right btn btn-primary\">Next</button>\n        </nav>\n        <div class=\"row flex-max\">\n            <div id=\"text\" class=\"col-xs-12\">\n            </div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
...
templates['data_collection/main.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"row\">\n    <div id=\"left-column\" class=\"col-xs-offset-3 col-xs-6 lesson-step\">\n        <nav class=\"row\">\n            <span></span>\n            <button id=\"btn-next\" class=\"btn btn-primary\">Next</button>\n        </nav>\n        <div class=\"row flex-max\">\n            <div id=\"text\" class=\"col-xs-12 answers-col\">\n            </div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
...
templates['staticpage/canvas.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;

  return "<div class=\"row\">\n    <div class=\"col-xs-6 col-xs-offset-3\" id=\"page-content\">\n        "
    + ((stack1 = ((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"content","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n    </div>\n</div>\n";
},"useData":true});
