...
interactive teaching components.
    ...
    and the use of any libraries and frameworks are justified.
        ...
        components or sections of the UI. In the same way that the
        ...
        overall look and feel of the UI. The latest development
...
the system and suggestions for future development. The report concludes
with an assessment of the success or failure of the project as a
whole.
