...
\chapter{Design}
This chapter discusses the overall design and architecture of the
...
conceptual problems.
    ...
    For these reasons the proposal has been modified to create a
    ...
    concepts and gradually introduce each element of the simulation.

    By slowly exposing the components to the student and providing a
    variety of ways in which to explore the material, it is hoped that
    the system will prove a valuable tool for learning alongside
    existing resources such as textbooks and lectures.
    ...
    solutions are suggested.
        ...
        As the original intention was to make such a system available
        to COPT students available via the University, the following
        ...
        For these reasons the following constraints have been applied
        to the project:
        
        \begin{itemize}
        \item The application will be developed using client-side
          technologies available in all web browsers, including
          JavaScript, HTML and CSS, which may be distributed using a
          standard web server such as the one already used to host the
          course webpage.
        \item Use of popular libraries and frameworks such as jQuery
          and Bootstrap will be encouraged, as this will:
          \begin{itemize}
          \item reduce load times, since the user has likely already
            downloaded the required files; and
          \item provide security and robustness due to those projects'
        ...
        \begin{itemize}
        \item Enable access to a range of methods of study;
        \item Provide comprehensive coverage of the topic at hand;
        \item Ensure the content included is correct, clear and concise; and
...
by the visual elements described in chapter \ref{chap:visualisation}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Data-Flow Analysis Visualisation}\label{chap:visualisation}
Blah Blah
