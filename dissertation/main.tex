...
as a whole.
    ...
    Figure \ref{fig:lessons-complete} shows the number of lessons
    attempted versus the number of lessons completed. 

    \begin{wrapfigure}[24]{r}{6cm}
      \centering
      \vspace{-6mm}
      \includegraphics[width=5cm, trim=15 35 35 45]{img/lessons.pdf}
    ...
    % \& \ref{fig:demo-q2} and may be summarised as follows. Figure
    % \ref{fig:time-hist} shows a histogram of the time spent using the
    % system by each of the 37 participants.
    ...
    A total of 28 participants responded to the feedback survey, 23 of
    whom spent more than 5 minutes participating in the evaluation
    ...
    \begin{figure}[!hb]
      \centering
      \captionsetup{width=\textwidth, justification=centering}
      \caption{Opinion of Round-Robin Simulator}\label{fig:demo-q2}
      \includegraphics[width=\textwidth, trim=0 0 0 0]{img/simulator_opinion.pdf}
    \end{figure}

    \subsection{Interactive Lessons}

    \begin{figure}[!hb]
      \centering
      \captionsetup{width=\textwidth, justification=centering}
      \caption{Opinion of Interactive Lessons}\label{fig:demo-q2}
      \includegraphics[width=\textwidth, trim=0 0 0 0]{img/lesson_opinion.pdf}
    \end{figure}
