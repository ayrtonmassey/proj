...
%% Figures
\usepackage{tabularx}
\newcolumntype{m}{>{\arraybackslash$}c<{$}}     % centre-align math column
\newcolumntype{M}{>{\arraybackslash$}l<{$}}     % left-align math column
\newcolumntype{C}{>{\centering\arraybackslash}X}% fill-width centre-align column
\usepackage{caption}
\captionsetup{%
  figurename=fig.,
  tablename=tab.
...
{   
    ...
    \lstset{ %this is the stype
        ...
        keywords={,input, output, return, datatype, function, in, if,
          else, foreach, while, begin, end, for, each, is, not, of, true, false, } %add the keywords you want, or load a language as Rubens explains in his comment above.
        ndkeywords{this,},
        ...
        \begin{figure}[!ht]
          ...
          \begin{tabular}{M m M}
            ...
            ControlFlowOp & \rightarrow & ControlFlowOpcode \; OperandList \; \Rightarrow \; OperandList \\
                          &             &                                                                \\
            LoadOpCode    & \rightarrow & \text{loadI}                                                   \\
                          & |           & \text{loadAO}                                                  \\
                          & |           & ...                                                            \\
                          &             &                                                                \\
            StoreOpCode   & \rightarrow & \text{storeI}                                                  \\
                          & |           & \text{storeAO}                                                 \\
                          & |           & ...                                                            \\
                          &             &                                                                \\
